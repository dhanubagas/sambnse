...
>
  <head>
    ...
    <title>SELF ACTIVITY MARKETING</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="assets/img/favicon/logo-n.png" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">AGARI</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to SAM BNSE! 👋</h4>
              ...
              <form id="" class="mb-3" action="" method="post">
                ...
                <div class="mb-3">
                  <button name="btn_login" class="btn btn-primary d-grid w-100" type="submit">Sign in</button>
                </div>
              </form>
