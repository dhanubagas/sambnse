...
$jml = query("SELECT * FROM kuanti ORDER BY id DESC LIMIT 1")[0];
 ...
 ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Input Kuantitatif/<?= $jp['penilaian'] ?></span> </h4>
